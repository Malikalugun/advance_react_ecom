...
class ProductListController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        ...
        $name_gen1 = hexdec(uniqid()) . '.' . $imageFile1->getClientOriginalExtension();
    ...
    public function EditProduct($id)
    {
        ...
        return view('backend.product.product_edit', compact('category', 'subcategory', 'product', 'product_details'));
    }
